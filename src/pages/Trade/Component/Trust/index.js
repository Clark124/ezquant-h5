...
import { strategyList, deployStrategy } from '../../../../service/traderoom'

import './index.scss'
import arrow_icon from '../../../../asstes/images/grarrow.png'

import { changePeriod, setMyStrategyList, updateTrustData } from '../../actions'
    ...
    return (
        <div className="strategy-trust-wrapper">
            ...
            <div className="trust-item">
                <div>交易标的</div>
                <div className="trust-item-value">
                    <span>{props.quote.prod_name}({props.quote.prod_code})</span>
                </div>
            </div>
            <div className="trust-item">
                <div>策略资金</div>
