...
import { stopComboId, runComboId, updateCombinationOrder, changeNoticeCombo, comboInfoPublic, deleteComboInfo } from '../../../../service/compose'
    ...
    const onDelete = () => {
        Dialog.confirm({
            ...
            onConfirm: () => {
                ...
                deleteComboInfo({ id: id }).then(res => {
                    Toast.clear()
                    if (res === 'sucess') {
                        Toast.show({
                            icon: "success",
