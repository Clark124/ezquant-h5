...
class App extends Component {
    ...
    init(data, option,quote,period) {
        ...
        }, data, number, ctx,option,quote,period)

        let indicateChart = new IndicateChart({
            width: win_width,
            height: (160 / 750) * win_width
        }, data, number, ctxIndicate,period)
    ...
    refreshKline(value) {
        ...
        if (this.Chart && value.values.length > 0) {
            this.Chart.refreshKline(value)
        }
        if (this.IndicateChart && value.values.length > 0) {
    ...
    render() {
        ...
        return (
            <div className="chart-canvas">
                ...
                <canvas className='canvas1' width={win_width} height={(520 / 750) * win_width}
                ...
                <canvas className='canvas2' width={win_width} height={(160 / 750) * win_width}
